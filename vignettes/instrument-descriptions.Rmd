...
DOIs soon):
  ...
  Baser, RE (2022). PROscorer: Scoring Functions for Patient-Reported Outcome
  (PRO) Measures and Other Psychometric Instruments. R Package Version 0.0.2.
  https://cran.r-project.org/package=PROscorer
  
  Baser, RE (2022). Descriptions of Instruments Scored by PROscorer. R Package
  Vignette version 0.0.2. https://cran.r-project.org/package=PROscorer
...
2.  Baser, RE (2022). PROscorer: Scoring Functions for Patient-Reported Outcome
(PRO) Measures and Other Psychometric Instruments. R Package Version 0.0.2.
...
3.  Baser, RE (2022). PROscorer: Scoring Functions for Patient-Reported Outcome
(PRO) Measures and Other Psychometric Instruments. R Package Version 0.0.2.
...
4.  Baser, RE (2022). PROscorer: Scoring Functions for Patient-Reported Outcome
(PRO) Measures and Other Psychometric Instruments. R Package Version 0.0.2.
