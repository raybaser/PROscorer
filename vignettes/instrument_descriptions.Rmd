---
title: "PROscorer Instrument Descriptions"
author: "Ray Baser"
date: "`r Sys.Date()`"
output: 
...
__PROBLEM:__ Patient reported outcome (PRO) measures are frequently poorly and
inadequately described in formal research protocol documents and published
...
for Describing PRO Measures"_ that I developed based on personal experience and
several sources of "best practices" for describing measures (references coming
soon).
...
Please cite the PROscorer package and this vignette document:

  Baser, RE (2016). PROscorer: Score Common Patient-Reported Outcome (PRO) 
  Measures and Other Psychometric Instruments. R package version 0.0.1. 
  http://github.com/raybaser/PROscorer
  
  Baser, RE (2016). Descriptions of Instruments Scored by the PROscorer 
  R Package. R Package Vignette version 0.0.1. 
  https://cran.r-project.org/package=PROscorer


# Guidelines for Describing PRO Measures:

I developed the following guidelines during my service as a chair of the
Biostatistics Protocol Review Committee at Memorial Sloan Kettering Cancer
Center (MSKCC). If you would like to contribute a scoring function to the
PROscorer package, please use these guidelines to write a description of your
instrument.

Information to Include Descriptions of PRO Measures:
...
2.  Baser, RE. (2016). PROscorer: A Repository of Functions to Accurately Score
Commonly Used Patient-Reported Outcome Measures and Psychometric Questionnaires.
...
Sex & Marital Therapy, 31(1), 1–20.

4.  Baser, RE, Li, Y, & Carter, J. (2012). Psychometric validation of the female
sexual function index (FSFI) in cancer survivors. Cancer, 118(18), 4606–4618.
...
_scoreNARCC_ function in the _PROscorer_ R package**[REF 3]**.
...
Examining intuitive risk perceptions for cancer in diverse populations. Health,
Risk & Society, 16(3), 227–242.

2.  Baser, RE, Li, Y, Brennessel, D, Kemeny, MM, & Hay, JL. (2016). Measurement
Invariance of Intuitive Cancer Risk Perceptions Across Diverse Populations: The
Cognitive Causation and Negative Affect in Risk Scales. Journal of Health
Psychology.

3.  Baser, RE. (2016). PROscorer: A Repository of Functions to Accurately Score
Commonly Used Patient-Reported Outcome Measures and Psychometric Questionnaires.
R Package Version 0.0.1.
